        ...
        return {
            getInformTops: function(){
                ...
                $http({
                    ...
                    url:'/rap/fwpt/msgService/getMsg.do?bj=1&start=1&limit=4'})
        ...
        return{
            getInformList:function(){
                ...
                $http({
                    ...
                    url:'/rap/fwpt/msgService/getMsg.do?bj=2&start=1&limit=50'})
                    .success(function(data){
        ...
        return{
            getInformDetails:function(){
                ...
                $http({
                    ...
                    url:'/rap/fwpt/msgService/getMsgDetail.do?xxid='+listId})
                    .success(function(data){
